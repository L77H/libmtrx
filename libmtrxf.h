...
void cpymtrx(int w, int h, frac (*A)[w], matrix *M) {
	for (int i = 0; i < h; i++) {
		for (int j = 0; j < w; j++) {
...
void MTRX_FUNCTIONS_NO_R__addition(char *a, char *b) {
...
void MTRX_FUNCTIONS_NO_R__subtraction(char *a, char *b) {
	int *size_A = parse_matrix_size(a);
	int *size_B = parse_matrix_size(b);
...
void MTRX_FUNCTIONS_NO_R__multiplication(char *a, char *b) {
	int *size_A = parse_matrix_size(a);
	int *size_B = parse_matrix_size(b);
...
void MTRX_FUNCTIONS_NO_R__transpose(char *a) {
	int *size_A = parse_matrix_size(a);
...
void MTRX_FUNCTIONS_NO_R__invert(char *a) {
	int *size_A = parse_matrix_size(a);
...
void MTRX_FUNCTIONS_NO_R__determinant(char *a) {
	int *size_A = parse_matrix_size(a);
...
void MTRX_FUNCTIONS_NO_R__power(char *a, int n) {
	int *size_A = parse_matrix_size(a);
...
matrix *MTRX_FUNCTIONS_R__addition(char *a, char *b) {
...
matrix *MTRX_FUNCTIONS_R__subtraction(char *a, char *b) {
	matrix *M = (matrix *) malloc(sizeof(matrix));
...
matrix *MTRX_FUNCTIONS_R__multiplication(char *a, char *b) {
	matrix *M = (matrix *) malloc(sizeof(matrix));
...
matrix *MTRX_FUNCTIONS_R__transpose(char *a) {
	matrix *M = (matrix *) malloc(sizeof(matrix));
...
matrix *MTRX_FUNCTIONS_R__invert(char *a) {
	matrix *M = (matrix *) malloc(sizeof(matrix));
...
matrix *MTRX_FUNCTIONS_R__power(char *a, int n) {
	matrix *M = (matrix *) malloc(sizeof(matrix));
...
int MTRX_FUNCTIONS_R__determinant(char *a) {
	int *size_A = parse_matrix_size(a);
